  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex  justify-center mb-4">
        <Link
          to="/add"
          className="px-4 py-2 border-gray-300 bg-blue-700 text-white hover:bg-blue-600 active:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 px-4 py-2 rounded transition text-white rounded-md "
        >
          + Add Subscription
        </Link>
      </div>
